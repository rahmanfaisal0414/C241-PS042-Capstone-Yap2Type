...
public class VoiceRecorder {
    ...
    private AudioRecord createAudioRecord() {
        for (int sampleRate : SAMPLE_RATE_CANDIDATES) {
            ...
            if (sizeInBytes == AudioRecord.ERROR_BAD_VALUE || sizeInBytes == AudioRecord.ERROR) {
                continue;
            }
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    if (size == AudioRecord.ERROR_BAD_VALUE || size == AudioRecord.ERROR_INVALID_OPERATION) {
                        Log.e("ProcessVoice", "Error reading audio data");
                        break;
                    }
                    ...
                    if (isHearingVoice(mBuffer, size)) {
                        ...
                        mCallback.onVoice(Arrays.copyOf(mBuffer, size), size);
