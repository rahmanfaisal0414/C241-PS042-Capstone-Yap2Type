...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadScreenTextLayout();
    }

    private void loadScreenTextLayout() {
        setContentView(R.layout.activity_main);
        // Inisialisasi tampilan yang berkaitan dengan layout activity_main.xml
    ...
    private void loadScreenTextLayout2() {
        setContentView(R.layout.screen_text);
        // Inisialisasi tampilan yang berkaitan dengan layout screen_text.xml
        resultTextView = findViewById(R.id.result_text_view);
//
        // Inisialisasi tombol back
        Button summaryButton = findViewById(R.id.btnsummary);
        summaryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String transcription = resultTextView.getText().toString();
                // Simpan data ke DataHolder
                DataHolder.getInstance().setTranscription(transcription);
                // Pindah ke ScreenActivity
                loadScreenSummary();
            }
        });
    ...
    // Metode untuk pindah ke ScreenActivity
